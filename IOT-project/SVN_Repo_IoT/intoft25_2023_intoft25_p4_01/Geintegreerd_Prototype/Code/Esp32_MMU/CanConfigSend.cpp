...
void fillTable()
{
  ...
  addDataToTable(1, (1+startID29Bit), 50, 4, 0, ANALOG_PORT, ECG);  // ECG P1
  addDataToTable(1, (2+startID29Bit), 501, 2, 1, DIGITAL_PORT, HEMOGLOBIN);  // Hemoglobine P1
  addDataToTable(1, (3+startID29Bit), 502, 2, 2, DIGITAL_PORT, CHOLESTEROL);  // Cholesterol P1
  addDataToTable(1, (4+startID29Bit), 503, 2, 3, DIGITAL_PORT, UPPERPRESSURE);  // Bovendruk P1
  addDataToTable(1, (5+startID29Bit), 504, 4, 4, DIGITAL_PORT, NEGATIVEPRESSURE);  // Onderdruk P1
  addDataToTable(1, (6+startID29Bit), 505, 2, 1, ANALOG_PORT, HEARTBEAT);  // Hartslag P1
  addDataToTable(1, (7+startID29Bit), 506, 1, 6, DIGITAL_PORT, OXYGENLEVEL); // PID P1

  addDataToTable(2, (8+startID29Bit), 51, 1, 0 , ANALOG_PORT, ECG); // ECG P2
  addDataToTable(2, (9+startID29Bit), 507, 2, 10, DIGITAL_PORT, HEMOGLOBIN); // Hemoglobine P2
  addDataToTable(2, (10+startID29Bit), 508, 2, 11, DIGITAL_PORT, CHOLESTEROL); // Cholesterol P1
  addDataToTable(2, (11+startID29Bit), 509, 8, 12, DIGITAL_PORT, UPPERPRESSURE);  // Bovendruk P1
  addDataToTable(2, (12+startID29Bit), 510, 4, 13, DIGITAL_PORT, NEGATIVEPRESSURE);  // Onderdruk P1
  addDataToTable(2, (13+startID29Bit), 511, 2, 2, ANALOG_PORT, HEARTBEAT);  // Hartslag P1
  addDataToTable(2, (14+startID29Bit), 512, 2, 15, DIGITAL_PORT, OXYGENLEVEL);  // PID P1
}
