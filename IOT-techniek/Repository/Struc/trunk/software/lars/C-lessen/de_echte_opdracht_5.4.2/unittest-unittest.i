...
void test_1() {
  ...
  do { gint64 __n1 = (c), __n2 = (ROOD); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unittest.c", 8, ((const char*) (__func__)), "c" " " "==" " " "ROOD", (long double) __n1, "==", (long double) __n2, 'i'); } while (0);
}

void test_2() {
  Verwachting v = {.neerslag = 42, .temperatuur = 18.0, .windkracht = 2};
  Code c = waarschuwing(v);
  do { gint64 __n1 = (c), __n2 = (GEEL); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unittest.c", 14, ((const char*) (__func__)), "c" " " "==" " " "GEEL", (long double) __n1, "==", (long double) __n2, 'i'); } while (0);
}
void test_3() {
  Verwachting v = {.neerslag = 0, .temperatuur = 25.0, .windkracht = 2};
  Code c = waarschuwing(v);
  do { gint64 __n1 = (c), __n2 = (GROEN); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unittest.c", 19, ((const char*) (__func__)), "c" " " "==" " " "GROEN", (long double) __n1, "==", (long double) __n2, 'i'); } while (0);
}
void test_4() {
  Verwachting v = {.neerslag = 22, .temperatuur = 38.0, .windkracht = 6};
  Code c = waarschuwing(v);
...
# 29 "unittest.c"
                            , 0, 0);
  g_test_trap_assertions (((gchar*) 0), "unittest.c", 30, ((const char*) (__func__)), 2, "!! Weeralarm: neerslag: 22 mm, temperatuur: 38.0 " "celsius, windkracht: 6\n")
                                                       ;
}
void test_5() {
  int8_t w = 8;
  Verwachting v = {.neerslag = 18, .temperatuur = 16.0, .windkracht = w};
  do { gint64 __n1 = (sizeof(v.windkracht)), __n2 = (1); if (__n1 == __n2) ; else g_assertion_message_cmpnum (((gchar*) 0), "unittest.c", 36, ((const char*) (__func__)), "sizeof(v.windkracht)" " " "==" " " "1", (long double) __n1, "==", (long double) __n2, 'i'); } while (0)
                    ;
}
