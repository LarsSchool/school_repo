...
void log_(const char* msg) { printf(msg); }
...
228");
  ...
  // }
  // {
  //   reset_buffer("GET /sensors/1/stdev
  //   HTTP/1.0\r\n\r\n"); struct response received =
  //   handleRequest(stream); g_assert_cmpint(received.code,
  //   ==, OK_200_GET_STDEV);
  ...
  // }
  // {
  //   reset_buffer("GET /sensors/1/actual
  //   HTTP/1.0\r\n\r\n"); struct response received =
  //   handleRequest(stream); g_assert_cmpint(received.code,
  //   ==, OK_200_GET_ACTUAL);
