...
{
  uint16_t i;
  float step = 200;  // You can adjust this step to change the interpolation resolution, hoort rond de 0,5 te zijn, want dan is het 2 keer zo snel.
  int waarde = 0;
  ...
  for (i = 0; i < 511; i++)   // Only loop to 511 to avoid out of bounds on the last value
  {
    ...
    // delay(100);  // This delay might need to be adjusted based on the desired waveform frequency and the time taken for I2C operations
